...
import 'tree_teams_widget.dart' show TreeTeamsWidget;
import 'package:flutter/material.dart';

class TreeTeamsModel extends FlutterFlowModel<TreeTeamsWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetTeam)] action in TreeTeams widget.
