...
import 'dispatches_orig_model.dart';
export 'dispatches_orig_model.dart';

class DispatchesOrigWidget extends StatefulWidget {
  const DispatchesOrigWidget({super.key});

  static String routeName = 'dispatchesOrig';
  static String routePath = '/dispatchesOrig';

  @override
  State<DispatchesOrigWidget> createState() => _DispatchesOrigWidgetState();
}

class _DispatchesOrigWidgetState extends State<DispatchesOrigWidget>
    with TickerProviderStateMixin {
  late DispatchesOrigModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatchesOrigModel());
                                                                                                                                                    ...
                                                                                                                                                    child: FFButtonWidget(
                                                                                                                                                      onPressed: () async {
                                                                                                                                                        ...
                                                                                                                                                        if (selectedMedia != null && selectedMedia.every((m) => validateFileFormat(m.storagePath, context))) {
                                                                                                                                                          safeSetState(() => _model.isDataUploading_uploadDataSlgOrig = true);
                                                                                                                                                          ...
                                                                                                                                                          try {
                                                                                                                                                            ...
                                                                                                                                                            _model.isDataUploading_uploadDataSlgOrig = false;
                                                                                                                                                          }
                                                                                                                                                          if (selectedUploadedFiles.length == selectedMedia.length && downloadUrls.length == selectedMedia.length) {
                                                                                                                                                            safeSetState(() {
                                                                                                                                                              _model.uploadedLocalFile_uploadDataSlgOrig = selectedUploadedFiles.first;
                                                                                                                                                              _model.uploadedFileUrl_uploadDataSlgOrig = downloadUrls.first;
                                                                                                                                                            });
                                                                                                                                                          } else {
                                                                                                                                                            safeSetState(() {});
                                                                                                                                                            return;
                                                                                                                                                        ...
                                                                                                                                                        _model.iconUrlPath = _model.uploadedFileUrl_uploadDataSlgOrig;
                                                                                                                                                        _model.contentUpdated = true;
                                                                                                                                                        safeSetState(() {});
                                                                                                                                                      },
                                                                                                                                                      text: 'Upload',
                                                                                                                              ...
                                                                                                                              child: Padding(
                                                                                                                                ...
                                                                                                                                child: FFButtonWidget(
                                                                                                                                  onPressed: () async {
                                                                                                                                    ...
                                                                                                                                    if (selectedMedia != null && selectedMedia.every((m) => validateFileFormat(m.storagePath, context))) {
                                                                                                                                      safeSetState(() => _model.isDataUploading_uploadDataHelpImage = true);
                                                                                                                                      var selectedUploadedFiles = <FFUploadedFile>[];
                                                                                                                                      ...
                                                                                                                                      try {
                                                                                                                                        ...
                                                                                                                                        _model.isDataUploading_uploadDataHelpImage = false;
                                                                                                                                      }
                                                                                                                                      if (selectedUploadedFiles.length == selectedMedia.length && downloadUrls.length == selectedMedia.length) {
                                                                                                                                        safeSetState(() {
                                                                                                                                          _model.uploadedLocalFile_uploadDataHelpImage = selectedUploadedFiles.first;
                                                                                                                                          _model.uploadedFileUrl_uploadDataHelpImage = downloadUrls.first;
                                                                                                                                        });
                                                                                                                                      } else {
                                                                                                                                        safeSetState(() {});
                                                                                                                                        return;
