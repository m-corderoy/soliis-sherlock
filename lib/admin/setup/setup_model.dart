...
class SetupModel extends FlutterFlowModel<SetupWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetTree)] action in setup widget.
  ApiCallResponse? getInitialLocation;
  // Stores action output result for [Backend Call - API (GetTeam)] action in setup widget.
  ...
  String uploadedFileUrl_uploadDataImage = '';
