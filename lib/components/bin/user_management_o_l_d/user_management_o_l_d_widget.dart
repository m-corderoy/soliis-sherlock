...
import 'user_management_o_l_d_model.dart';
export 'user_management_o_l_d_model.dart';

class UserManagementOLDWidget extends StatefulWidget {
  const UserManagementOLDWidget({
    super.key,
    String? imageurl,
  ...
  static String routeName = 'userManagementOLD';
  static String routePath = '/userManagement';

  @override
  State<UserManagementOLDWidget> createState() =>
      _UserManagementOLDWidgetState();
}

class _UserManagementOLDWidgetState extends State<UserManagementOLDWidget>
    with TickerProviderStateMixin {
  late UserManagementOLDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserManagementOLDModel());
