...
import '/index.dart';
import 'dart:async';
import 'dispatches_orig_widget.dart' show DispatchesOrigWidget;
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

class DispatchesOrigModel extends FlutterFlowModel<DispatchesOrigWidget> {
  ...
  bool isDataUploading_uploadDataSlgOrig = false;
  FFUploadedFile uploadedLocalFile_uploadDataSlgOrig =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataSlgOrig = '';
  ...
  bool isDataUploading_uploadDataHelpImage = false;
  FFUploadedFile uploadedLocalFile_uploadDataHelpImage =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataHelpImage = '';
