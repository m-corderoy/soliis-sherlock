...
import 'account_update_model.dart';
export 'account_update_model.dart';

class AccountUpdateWidget extends StatefulWidget {
  const AccountUpdateWidget({super.key});

  @override
  State<AccountUpdateWidget> createState() => _AccountUpdateWidgetState();
}

class _AccountUpdateWidgetState extends State<AccountUpdateWidget> {
  late AccountUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountUpdateModel());
