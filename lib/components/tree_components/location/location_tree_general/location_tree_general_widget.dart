...
import 'location_tree_general_model.dart';
export 'location_tree_general_model.dart';

class LocationTreeGeneralWidget extends StatefulWidget {
  const LocationTreeGeneralWidget({
    super.key,
    required this.rowid,
    this.rowdata,
    this.opMode,
  ...
  @override
  State<LocationTreeGeneralWidget> createState() =>
      _LocationTreeGeneralWidgetState();
}

class _LocationTreeGeneralWidgetState extends State<LocationTreeGeneralWidget> {
  late LocationTreeGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LocationTreeGeneralModel());
                        ...
                        return Align(
                          ...
                          child: Container(
                            ...
                            child: LocationTreeGeneralWidget(
                              key: Key(
                                  'Keyo1t_${subtreeTeamsIndex}_of_${subtreeTeams.length}'),
                              rowid: getJsonField(
                                _model.treedatateam
