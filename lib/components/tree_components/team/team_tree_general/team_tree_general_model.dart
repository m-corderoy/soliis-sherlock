...
import 'team_tree_general_widget.dart' show TeamTreeGeneralWidget;
import 'package:flutter/material.dart';

class TeamTreeGeneralModel extends FlutterFlowModel<TeamTreeGeneralWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetTeam)] action in teamTreeGeneral widget.
