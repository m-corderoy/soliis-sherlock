...
class TeamsModel extends FlutterFlowModel<TeamsWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetTree)] action in teams widget.
  ApiCallResponse? getInitialLocation;
  // Stores action output result for [Backend Call - API (GetTeam)] action in teams widget.
