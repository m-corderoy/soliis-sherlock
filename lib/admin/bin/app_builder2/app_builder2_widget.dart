...
import 'app_builder2_model.dart';
export 'app_builder2_model.dart';

class AppBuilder2Widget extends StatefulWidget {
  const AppBuilder2Widget({super.key});

  static String routeName = 'appBuilder2';
  static String routePath = '/appBuilder2';

  @override
  State<AppBuilder2Widget> createState() => _AppBuilder2WidgetState();
}

class _AppBuilder2WidgetState extends State<AppBuilder2Widget>
    with TickerProviderStateMixin {
  late AppBuilder2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppBuilder2Model());
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            controller: _model.dropDownCardsValueController ??=
                                                                                FormFieldController<int>(
                                                                              _model.dropDownCardsValue ??= null,
                                                                            ),
                                                                            options:
                                                                                List<int>.from(containerReportRowList.map((e) => e.id).toList()),
                                                                            optionLabels:
                                                                                containerReportRowList.map((e) => e.name).toList(),
                                                                            onChanged:
                                                                                (val) async {
                                                                              ...
                                                                              _model.cardID = _model.dropDownCardsValue;
                                                                              safeSetState(() {});
                                                                            },
                                                                            width:
                                                                                320.0,
                                                                                  ...
                                                                                  child: FlutterFlowIconButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      if ((_model.chatInit4?.succeeded ?? true)) {
                                                                                        ...
                                                                                        safeSetState(() {
                                                                                          _model.usageThresholdTextController?.text = _model.viewThreshold!.toString();
                                                                                        });
                                                                                        await Future.delayed(
                                                                                          Duration(
                                                                                            milliseconds: 500,
