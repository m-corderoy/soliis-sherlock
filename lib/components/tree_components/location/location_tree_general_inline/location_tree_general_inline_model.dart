...
import 'location_tree_general_inline_widget.dart'
    show LocationTreeGeneralInlineWidget;
import 'package:flutter/material.dart';

class LocationTreeGeneralInlineModel
    extends FlutterFlowModel<LocationTreeGeneralInlineWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetTree)] action in locationTreeGeneralInline widget.
