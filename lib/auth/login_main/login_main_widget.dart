...
class _LoginMainWidgetState extends State<LoginMainWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().session = SessionStruct.fromSerializableMap(jsonDecode(
                    ...
                    child: Align(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'The operational nervous system for your organisation',
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Forgotten Password'),
                                                            content: Text(
                                                                'A password reset email will be sent, do you wish to continue?'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
