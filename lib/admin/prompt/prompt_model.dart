...
class PromptModel extends FlutterFlowModel<PromptWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetTree)] action in prompt widget.
  ApiCallResponse? getInitialLocation;
  // Stores action output result for [Backend Call - API (GetTeam)] action in prompt widget.
