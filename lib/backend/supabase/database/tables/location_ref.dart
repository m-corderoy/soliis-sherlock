...
class LocationRefTable extends SupabaseTable<LocationRefRow> {
  @override
  String get tableName => 'locationRef';

  @override
  LocationRefRow createRow(Map<String, dynamic> data) => LocationRefRow(data);
}

class LocationRefRow extends SupabaseDataRow {
  LocationRefRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => LocationRefTable();
  ...
  String? get locationRef => getField<String>('locationRef');
  set locationRef(String? value) => setField<String>('locationRef', value);
