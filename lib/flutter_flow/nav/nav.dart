...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomeWidget() : LoginMainWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: TenantManagementWidget.routeName,
          path: TenantManagementWidget.routePath,
          requireAuth: true,
          builder: (context, params) => TenantManagementWidget(),
        ),
        FFRoute(
